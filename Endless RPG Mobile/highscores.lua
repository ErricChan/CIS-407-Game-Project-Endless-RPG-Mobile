...
function scene:create( event )
  ...
  local highScoresHeader = display.newText(sceneGroup,"High Scores",display.contentCenterX,20,native.systemFont,44)
  ...
  local replayButton = display.newText(sceneGroup,"Play",display.contentCenterX,450,native.systemFont,44)
