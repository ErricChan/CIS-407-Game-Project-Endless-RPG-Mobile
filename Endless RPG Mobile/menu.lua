...
function scene:create( event )
  ...
  local title = display.newText(sceneGroup,"Endless RPG\nMobile",display.contentCenterX,100,native.systemFont,44)
  title:setFillColor(0,0,0)
  
  local playButton = display.newText(sceneGroup,"Play",display.contentCenterX,350,native.systemFont,44)
  playButton:setFillColor(0,0,0)
  
  local highscoreButton = display.newText(sceneGroup,"High Scores",display.contentCenterX,450,native.systemFont,44)
